...
export function Experience() {
  return (
    ...
    >
      <div className="   w-full flex flex-col gap-4 items-start md:items-center justify-center">
      ...
      <div className="flex flex-col text-start items-start w-fit !mx-auto justify-start gap-10">
        <div className="flex  gap-10 items-start justify-between w-full flex-1 ">
        ...
        <div className="flex  gap-10 items-start justify-between w-full flex-1 ">
          ...
          <div className="text-right">
            <p className="text-md max-w-3xl font-[500]">GAOTek Inc.</p>
        ...
        <div className="flex  gap-10 items-start justify-between w-full flex-1 ">
          <h3 className="text-2xl font-[600]">Freelancer</h3>
          <div className="text-right">
            <p className="text-md max-w-3xl font-[500]">Web development</p>
            <p className="text-sm max-w-3xl ">JAN 2023 - PRESENT</p>
            <p className="text-sm max-w-3xl text-[#83b541] font-[500]">
              Lagos, Nigeria{" "}
            </p>
          </div>
